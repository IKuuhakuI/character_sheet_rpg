class FichasController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @ficha.update(ficha_params)
        format.html { redirect_to @ficha, notice: 'Ficha atualizada com sucesso' }
  ...
  def destroy
    @ficha.destroy
    respond_to do |format|
      format.html { redirect_to fichas_url, notice: 'Ficha destruída com sucesso' }
  ...
  private
    ...
    def ficha_params
      params.require(:ficha).permit(:Nome, :Raça, :Classe, :Nível, :Antecedente, :Alinhamento, :Dado_Vida, :Força, :Destreza, :Constituição, :Inteligência, :Sabedoria, :Carisma, :Classe_de_Armadura)
    end
end
